...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['href' => '#', 'variant' => 'secondary', 'icon' => null, 'class' => '']));
...
foreach (array_filter((['href' => '#', 'variant' => 'secondary', 'icon' => null, 'class' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<a href="<?php echo e($href); ?>" <?php echo e($attributes->merge(['class' => "$baseClass $variantClass $class"])); ?>>
    <?php if($icon): ?>
...
<?php /**PATH C:\Users\Lenovo\Downloads\presma\resources\views/components/button-link.blade.php ENDPATH**/ ?>