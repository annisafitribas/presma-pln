        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between gap-6">
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    <span
                        class="relative inline-flex items-center px-3 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300">
...
<?php endif; ?>
<?php /**PATH C:\Users\Lenovo\Downloads\presma\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>